...
export default function IngredientsTemplate({data, chosen, display, addChosen}) {
    return (
        <div className={style.container} style={display ? {display:"block"} : {display:"none"}} onClick={()=> addChosen(data)}>
            <div className={style.avata}>
                <div className={style.avataImage}>
                    <Image src={data.url} layout="fill" objectFit="contain" objectPosition="center center" alt={data.alt}/>
                </div>
                <div className={style.chosen} style={chosen? null : {display:"none"}}>
